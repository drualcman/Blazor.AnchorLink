namespace Blazor.AnchorLink;
public partial class AnchorLink : IAsyncDisposable
{
    ...
    private Task<IJSObjectReference> GetJSObjectReference() =>
        JSRuntime.InvokeAsync<IJSObjectReference>(
            "import", $"./_content/{typeof(AnchorLink).Assembly.GetName().Name}/AnchorLink.js").AsTask();
